									...
									<table class="table align-middle gs-0 gy-4">
										...
										<thead>
											<tr class="fw-bolder text-muted bg-light">
												...
												<th class="min-w-225px rounded-start">Thumbnail</th>
												<th class="min-w-225px rounded-start">Link</th>
												<th class="min-w-200px text-center rounded-end">Actions</th>
											</tr>
										</thead>
										<!--end::Table head-->
										<!--begin::Table body-->
										<tbody id="table-product-information">
				...
				<div class="modal-dialog modal-dialog-centered mw-650px">
					...
					<div class="modal-content">
						...
						<div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
							...
							<div class="fv-row">
								<!--begin::Form-->
								<form class="form" action="<?= base_url('master_data/product_information/save') ?>" method="post" enctype="multipart/form-data">
									<div class="mb-10">
									...
									<div class="mb-10">
										<label for="link" class="required form-label">Link video</label>
										<input type="text" class="form-control form-control-solid" id="link" name="link" placeholder="link" />
									</div>
									<!--end::Input group-->
									<!--begin::Actions-->
