...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
	...
	<div class="post d-flex flex-column-fluid" id="kt_post">
		...
		<div id="kt_content_container" class="container">
						...
						<div class="card mb-5 mb-xl-8">
							...
							<div class="card-header border-0 pt-5">
								...
								<div class="card-toolbar">
									<a href="#" class="btn btn-sm btn-light-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_new_jumbotron" id="kt_toolbar_primary_button">
									...
									<table class="table align-middle gs-0 gy-4">
										...
										<thead>
											<tr class="fw-bolder text-muted bg-light">
												...
												<th class="min-w-225px rounded-start">Description</th>
												<th class="min-w-225px rounded-start">Status</th>
												<th class="min-w-200px text-center rounded-end">Actions</th>
											</tr>
										</thead>
										<!--end::Table head-->
										<!--begin::Table body-->
										<tbody id="table-jumbotron">
			...
			<div class="modal fade" id="kt_modal_new_jumbotron" tabindex="-1" aria-hidden="true">
				<!--begin::Modal dialog-->
				<div class="modal-dialog modal-dialog-centered mw-650px">
					...
					<div class="modal-content">
						...
						<div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
							...
							<div class="fv-row">
								<!--begin::Form-->
								<form class="form" action="<?= base_url('master_data/jumbotron/save') ?>" method="post" enctype="multipart/form-data">
									<div class="mb-10">
										<label for="exampleFormControlInput1" class="required form-label">Image</label><br>
									...
									<div class="mb-10">
										<label for="shortdescription" class="required form-label">Description</label>
										<input type="text" class="form-control form-control-solid" id="shortdescription" name="shortdescription" placeholder="short description" />
									</div>
									<!--begin::Actions-->
						...
						<div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
							...
							<div class="fv-row">
								...
								<form class="form" action="<?= base_url('master_data/product/save') ?>" method="post" enctype="multipart/form-data">
									<div class="mb-10">
										<label for="exampleFormControlInput1" class="required form-label">Image</label><br>
										<input id="fileEdit" type="file" name="file" />
									</div>
									<div class="mb-10">
										<label for="exampleFormControlInput1" class="required form-label">Title</label>
									...
									<div class="mb-10">
										...
										<input type="text" class="form-control form-control-solid" id="descriptionEdit" name="descriptionEdit" placeholder="Title" />
									</div>
									<!--begin::Actions-->
									<div class="text-center pt-15">
										<button type="reset" id="kt_modal_new_card_cancel" data-bs-dismiss="modal" class="btn btn-light me-3">Discard</button>
